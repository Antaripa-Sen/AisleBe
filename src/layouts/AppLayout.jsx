...
export default function AppLayout() {
  ...
  return (
    <div className="flex-1 flex flex-col md:flex-row h-full w-full relative overflow-hidden bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-dark-800 via-dark-900 to-black">
      
      {/* Desktop/Tablet Sidebar */}
      <nav className="hidden md:flex flex-col w-24 lg:w-64 h-full border-r border-white/5 bg-dark-900/60 backdrop-blur-2xl z-50 shrink-0">
      ...
      {/* Mobile Bottom Bar */}
      <div className="md:hidden absolute bottom-0 inset-x-0 pb-safe pt-2 px-2 bg-dark-900/90 backdrop-blur-2xl border-t border-white/10 z-50 rounded-t-[2.5rem] shadow-[0_-20px_40px_rgba(0,0,0,0.4)] flex justify-between">
        {navItems.map((item) => {
          const Icon = item.icon;
          return (
            <NavLink 
